...
const ecosystemExamples = [
  { test: /GitLab/, values: { GITLAB_NAMESPACE: "gitlab-org", REPO: "gitlab" } },
  { test: /JavaScript|npm|TypeScript/, values: { OWNER: "eslint", REPO: "eslint", PACKAGE: "eslint" } },
  { test: /Docker/, values: { DOCKER_SCOPE: "library", IMAGE: "alpine" } },
  { test: /Go module/, values: { OWNER: "gin-gonic", REPO: "gin", MODULE: "github.com/gin-gonic/gin" } },
  { test: /PowerShell/, values: { OWNER: "pester", REPO: "Pester", MODULE: "Pester" } },
  { test: /Terraform/, values: { OWNER: "hashicorp", REPO: "terraform-provider-random" } },
  { test: /Helm/, values: { OWNER: "helm", REPO: "helm" } },
  { test: /Python|PyPI/, values: { OWNER: "psf", REPO: "requests", PACKAGE: "requests" } },
  { test: /Rust/, values: { OWNER: "serde-rs", REPO: "serde", CRATE: "serde" } },
  { test: /Ruby/, values: { OWNER: "rails", REPO: "rails", GEM: "rails" } },
  { test: /Packagist|PHP/, values: { OWNER: "Seldaek", REPO: "monolog", VENDOR: "monolog", PACKAGE: "monolog" } },
  { test: /NuGet|\.NET/, values: { OWNER: "JamesNK", REPO: "Newtonsoft.Json", PACKAGE: "Newtonsoft.Json" } },
  { test: /Maven|JVM/, values: { OWNER: "apache", REPO: "commons-lang", BRANCH: "master" } },
  { test: /Dart|Flutter/, values: { OWNER: "dart-lang", REPO: "http", PACKAGE: "http" } },
  { test: /Haskell|Hackage/, values: { OWNER: "haskell", REPO: "aeson", PACKAGE: "aeson" } },
  { test: /CRAN|R package/, values: { OWNER: "tidyverse", REPO: "ggplot2", PACKAGE: "ggplot2" } },
  { test: /LaTeX|CTAN/, values: { OWNER: "latex3", REPO: "hyperref", PACKAGE: "hyperref" } },
  { test: /D package|DUB/, values: { OWNER: "vibe-d", REPO: "vibe.d", PACKAGE: "vibe-d" } },
  { test: /Elm/, values: { OWNER: "elm", REPO: "json", PACKAGE: "json" } },
  { test: /Haxe/, values: { OWNER: "HaxeFoundation", REPO: "hxcpp", PACKAGE: "hxcpp" } },
  { test: /OCaml|opam/, values: { OWNER: "ocaml", REPO: "dune", PACKAGE: "dune" } },
  { test: /Perl|CPAN/, values: { OWNER: "moose", REPO: "Moose" } },
  { test: /Crystal/, values: { OWNER: "kemalcr", REPO: "kemal", PACKAGE: "kemal" } },
  { test: /Swift|Objective-C|CocoaPods/, values: { OWNER: "Alamofire", REPO: "Alamofire" } },
  { test: /Visual Studio|VS Code|Open VSX/, values: { OWNER: "microsoft", REPO: "vscode-cpptools" } },
  { test: /Chrome|Firefox|Edge/, values: { OWNER: "gorhill", REPO: "uBlock" } },
...
function exampleValue(entry, placeholder) {
  ...
  return ecosystem?.values[placeholder] ?? generalExamples[placeholder] ?? placeholder;
}
...
function updateCode(entry, card) {
  card.querySelector("[data-markdown]").textContent = replacePlaceholders(entry, false);
}
...
function buildCard(entry) {
  ...
  previewLabel.textContent = entry.placeholders.length > 0 ? "Example preview" : "Live preview";
  ...
  copyButton.addEventListener("click", async () => {
    try {
      ...
      showToast(error instanceof Error ? error.message : "Could not copy Markdown.");
    }
  });
...
document.querySelector("#layout-total").textContent = catalog.layoutCount.toLocaleString();
document.querySelector("#badge-total").textContent = catalog.badgeCount.toLocaleString();
document.querySelector("#category-total").textContent = catalog.categoryCount.toLocaleString();
